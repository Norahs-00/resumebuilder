import { ai, hasOpenAIKey } from "../configs/ai.js";
...
export const uploadResume = async (req, res) => {
  try {
    const { resumeText: resumeTextBody, title } = req.body;
    const userId = req.userId;
    let resumeText = resumeTextBody;
    ...
    if (!resumeText) {
      return res.status(400).json({ message: "Missing required fields: resumeText or file" });
    }
